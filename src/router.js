...
const router = new Router({
    ...
    routes: [
        ...
        {path: '/position', name: 'position', component: Position, meta: {title: i18n.t('lang.article_page')}},
        ...
        {path: '/shopHome/:id', name: 'shopHome', component: ShopHome},
        {path: '/shop', name: 'shop', component: Shop, meta: {title: i18n.t('lang.shop_street')}},
        {path: '/shopDetail/:id', name: 'shopDetail', component: ShopDetail, meta: {title: i18n.t('lang.shop_details')}},
        {path: '/ShopGoodsList', name: 'shopGoodsList', component: ShopGoodsList, meta: {title: i18n.t('lang.shop_goods_list_page')}},
        ...
        {path: '/searchList', name: 'searchList', component: SearchList,meta:{title: i18n.t('lang.search_list')}},
...
router.beforeEach(async(route, redirect, next) => {
    ...
    //     next()
    // }else{           //需要登陆
    //    if(store.state.token !== null){   //登陆过
    //         if(!needSupplierAuth){       //不需要权限
    //             next()
    //         }else{                       //需要权限
    //             store.dispatch('setSupplier').then(res=>{   //获取下supplierLoading（以改为false）
