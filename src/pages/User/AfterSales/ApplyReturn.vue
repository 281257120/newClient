<template>
    ...
    <section class="section-list">
        ...
        <div class="product-list product-list-small" v-if="goodsList">
            ...
            <li v-for="(goodsInfo,index) in goodsList" :key="index">
              <div class="product-div">
                ...
                <div class="product-info">
                  ...
                  <div class="price" v-if="goodsInfo.goods_bonus > 0">- {{ goodsInfo.formated_goods_bonus }}</div>
...
export default{
  ...
  methods:{
    ...
    submitBtn(){
      ...
      this.$http.post(`${window.ROOT_URL}api/v4/refound/submit_return`,qs.stringify(o)).then(({data:{data}})=>{
        Toast({
          message: data.msg,
          duration:1000
        })
